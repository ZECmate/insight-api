...
BlockController.prototype.getBlockReward = function(height, callback) {
  ...
  // Subsidy is cut in half e;very 657850 blocks which will occur approximately every 4 years.
...
BlockController.prototype.getBlockRewardr = function(height) {
  // Subsidy is cut in half every 657850 blocks which will occur approximately every 4 years.
  var halvings;
  if (height <= 20000) {
    halvings = 0
  } else {
